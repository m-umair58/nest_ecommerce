...
var PaymentController = function () {
    ...
    var PaymentController = _classThis = /** @class */ (function () {
        function PaymentController_1(config) {
            this.stripe = __runInitializers(this, _instanceExtraInitializers);
            this.stripe = new stripe_1.default(config.get('SEC_KEY')); // Replace with your secret key
        }
        PaymentController_1.prototype.createPaymentIntent = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            error_1 = _a.sent();
                            console.error('Error creating payment intent:', error_1.message);
    ...
    (function () {
        ...
        _createPaymentIntent_decorators = [(0, common_1.Post)('create-payment-intent')];
